...
pyver = float(f"{_sys.version_info[:2][0]}.{_sys.version_info[:2][1]}")
...
class EnumMeta(type):
    ...
    def __new__(metacls, cls, bases=None, classdict=None):
        ...
        if invalid_names:
            invalid_names_list = ', '.join(invalid_names)
            raise ValueError(f'Invalid enum member name(s): {invalid_names_list}')
...
########################################################
temp_enum_dict = {}
temp_enum_dict['__doc__'] = "Generic enumeration.\n\n    Derive from this class to define " +\
                            "new enumerations.\n\n"
...
if pyver < 2.6:
    ...
    def __cmp__(self, other):
        ...
        raise TypeError(f"unorderable types: {self.__class__.__name__}() and "
    ...
    def __le__(self, other):
        raise TypeError(f"unorderable types: {self.__class__.__name__}() "
                        f"<= {other.__class__.__name__}()")
