...
public class ietfDatastores extends ConfNamespace {
    public static final int hash = 1769400062;
    public int hash() {
        return ietfDatastores.hash;
    }

    public static final String id = "_onf-tapi-nc-2.0:onf-tapi-nc-2.0#urn:ietf:params:xml:ns:yang:ietf-datastores";
    public String id() {
        return ietfDatastores.id;
    }

    public static final String uri = "_onf-tapi-nc-2.0:onf-tapi-nc-2.0#urn:ietf:params:xml:ns:yang:ietf-datastores";
    public String uri() {
