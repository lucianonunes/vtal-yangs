...
class ZRCfpException(CoreFunctionPackException):
...
class ServiceException(ZRCfpException):
    def __init__(self, log, code, exp_msg=None):
        super().__init__(log, code, exp_msg, self)


# Status Codes 870-879 : Custom Template Errors
class CustomTemplateException(ZRCfpException):
    def __init__(self, log, code, exp_msg=None):
        super().__init__(log, code, exp_msg, self)
