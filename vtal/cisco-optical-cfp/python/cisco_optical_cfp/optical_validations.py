...
class TapiDynamicMappingValidator:
    def __init__(self, log):
        self.log = log
        self.log.info("Initilizing tapi-dynamic-map-validation callback")

    def cb_validate(self, tctx, kp, newval):
        self.log.info(f"ENTRY_POINT  tapi dynamic mapping validation callback on {kp}")
        ...
        try:
            ...
            raise
        self.log.info(AsciiArt.castle)
        self.log.info(f"EXIT_POINT  tapi dynamic mapping validation callback on {kp}")
        return _ncs.OK
