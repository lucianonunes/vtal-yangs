...
class UMXR:
    def conf_l3vpn(self, endpoint):
        self.log.info(f"Configuring Flat L3VPN/SR on UM NC IOSXR device {endpoint.access_pe}")
        export_mappingv4 = ""
        export_mappingv6 = ""
        import_mappingv4 = ""
        import_mappingv6 = ""
        ...
        l3vpn_template.apply("cisco-flat-L3vpn-fp-um-template", l3vpn_vars)
    ...
    def check_if_interface_exists(self, root, endpoint, service_interface_name,
        ...
        admin_status = (root.devices.device[endpoint.access_pe].live_status.
    ...
    def get_interface_shutdown_template(self):
        return "cisco-flat-L3vpn-fp-no-shutdown-iosxr-um-nc"
    ...
    def get_bgp_vrf_rd(self, root, device, bgp_as_no, vrf_name):
        rd_inst = root.devices.device[device].config\
            .Cisco_IOS_XR_um_router_bgp_cfg__router\
            .Cisco_IOS_XR_um_router_bgp_cfg__bgp\
            .Cisco_IOS_XR_um_router_bgp_cfg__as[bgp_as_no]\
